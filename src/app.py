...
activities = {
    ...
    "Soccer Club": {
        "description": "Outdoor soccer drills and friendly matches",
    ...
    "Art Club": {
        ...
        "max_participants": 16,
        "participants": ["zoe@mergington.edu", "maya@mergington.edu"]
    },
    "Drama Club": {
        "description": "Acting, stage production, and performance workshops",
        "schedule": "Thursdays, 4:15 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["noah@mergington.edu", "charlotte@mergington.edu"]
    },
    "Mathletes": {
        "description": "Problem solving and math competition preparation",
        "schedule": "Wednesdays, 3:30 PM - 4:30 PM",
        "max_participants": 14, 
        "participants": ["oliver@mergington.edu", "sophia@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Hands-on science experiments and competitive events",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
